...
const Footer = () => {
  ...
  return (
    <footer className="footer-container px-4 divide-y">
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        ...
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
          <div className="space-y-3">
            <h3 className="tracking-wide uppercase font-semibold dark:text-gray-800">
              Services
            </h3>
          ...
          <div className="space-y-3">
            <div className="tracking-wide uppercase font-semibold dark:text-gray-800">
              Social media
            </div>
      ...
      <div className="py-6 text-sm text-center dark:text-gray-400">
        &copy; {year} Doctors Portal, All rights reserved
      </div>
    </footer>
  );
};
