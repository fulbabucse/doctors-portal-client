        ...
        <div className="container px-4 lg:px-0 py-4 mx-auto">
          <div className="lg:flex lg:items-center lg:justify-between w-full">
            ...
            <div
              ...
              } absolute inset-x-0 z-20 flex-1 w-full px-6 py-0 transition-all duration-300 ease-in-out bg-white dark:bg-gray-800 lg:mt-0 lg:p-0 lg:top-0 lg:relative lg:bg-transparent lg:w-auto lg:opacity-100 lg:translate-x-0 lg:flex lg:items-center lg:justify-end`}
            >
